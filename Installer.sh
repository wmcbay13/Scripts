...
installer -pkg /Applications/Fortify_SCA_and_Apps_20.1.0.0005/Uninstaller

#Install new SCA Version
installer -pkg /Downloads/Fortify_SCA_and_Apps_20.2.1.mpkg -target /Applications/Fortify_SCA_and_Apps.20.2.xxxx/Applications/Fortify -dumplog ~/TEMP
